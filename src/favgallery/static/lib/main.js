...
// showNotice / notifyAuthFailure は notices.js から import (Phase 4B)
...
// 本棚タブ (Bookshelf + Book Upload + cover observer) は bookshelf.js へ分離 (Phase 4B)

// 漫画リーダー (Book Reader + Reader slide track) は reader.js へ分離 (Phase 4B)
